...
javac -d bin\classes -cp %classpath% src\comp3350\organizr\objects\*.java src\comp3350\organizr\persistence\*.java src\comp3350\organizr\application\*.java src\comp3350\organizr\business\*.java
javac -d bin\classes -cp %classpath% src\comp3350\organizr\application\*.java src\comp3350\organizr\objects\*.java src\comp3350\organizr\persistence\*.java src\comp3350\organizr\business\*.java src\comp3350\tests\business\*.java src\comp3350\tests\RunIntegrationTests.java src\comp3350\tests\RunUnitTests.java src\comp3350\tests\persistence\*.java src\comp3350\tests\objects\*.java src\comp3350\tests\integration\*.java
